...
- 왼쪽 서브트리의 크기가 <img src="https://latex.codecogs.com/svg.latex?\Large&space;l" /> 이라고 할 때, 다음과 같은 3가지 경우 존재
  - <img src="https://latex.codecogs.com/svg.latex?\Large&space;k \leq l" /> : <img src="https://latex.codecogs.com/svg.latex?\Large&space;k" /> 번째 노드는 왼쪽 서브트리에 속해 있다.
  - <img src="https://latex.codecogs.com/svg.latex?\Large&space;k = l + 1" /> : 루트가 <img src="https://latex.codecogs.com/svg.latex?\Large&space;k" /> 번째 노드 
  - <img src="https://latex.codecogs.com/svg.latex?\Large&space;k > l + 1" /> : <img src="https://latex.codecogs.com/svg.latex?\Large&space;k" /> 번째 노드는 오른쪽 서브트리에서 <img src="https://latex.codecogs.com/svg.latex?\Large&space;k-l-1" /> 번째 노드
...
- <img src="https://latex.codecogs.com/svg.latex?\Large&space;A[0 \cdots i-1]" /> 이 정렬된 배열일 때, <img src="https://latex.codecogs.com/svg.latex?\Large&space;A[i]" /> 를 적절한 위치를 만날 때까지 왼쪽으로 한 칸씩 움직인다.
...
- 테스트 케이스 수 <img src="https://latex.codecogs.com/svg.latex?\Large&space;C(1 \leq C \leq50)" />
- 원 배열의 길이 <img src="https://latex.codecogs.com/svg.latex?\Large&space;N(1 \leq N \leq 50000)" />
